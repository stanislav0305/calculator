		...
		stepElements:[
			{
				...
				items: [{
						id:'item-31-'+stepId,
						title:'Обычное',
						price: _calculatorConstsHelper.SKINALI_NORMAL_GLASSTYPE_PRICE,
					...
					},
					{
						id:'item-32-'+stepId,
						title:'Осветленное',
						price: _calculatorConstsHelper.SKINALI_CLARIFIED_GLASSTYPE_PRICE,
...
let installationStep = function(stepId, price){
 ...
 return {
		 init: function(calculatorConstsHelper){
			 _calculatorConstsHelper = calculatorConstsHelper;
		 },
							...
							items:[
								{
									...
									childSteps:[
													...
													items: [
														{
															...
															title:'Название',
															childSteps:[
																printingTypeStep('step-17', _calculatorConstsHelper.SHOWER_CABIN_PHOTO_PRINTING_PRICE, _calculatorConstsHelper.SHOWER_CABIN_MONOCHROMATIC_PAINTING_PRICE),
										...
										delivetyStep('step-25-2', _calculatorConstsHelper.SHOWER_CABIN_DELIVERY_PRICE),
										installationStep('step-25-3', _calculatorConstsHelper.SHOWER_CABIN_INSTALATION_PRICE)
									]
								},
								{
									id:'item-29',
									...
									childSteps:[
										...
										printingTypeStep('step-33',_calculatorConstsHelper.SKINALI_PHOTO_PRINTING_PRICE, _calculatorConstsHelper.SKINALI_MONOCHROMATIC_PAINTING_PRICE),
										{
											id:'step-39',
													...
													items:[
														{
															id:'item-62',
															title:'Надо',
															price:_calculatorConstsHelper.SKINALI_METRING_PRICE,
															childSteps:[
																delivetyStep('step-59-2', _calculatorConstsHelper.SKINALI_DELIVERY_PRICE),
																installationStep('step-59-3', _calculatorConstsHelper.SKINALI_INSTALATION_PRICE)
															]
														},
														{
															id:'item-63',
															...
															isSelected:true,
															childSteps:[
																delivetyStep('step-59-4', _calculatorConstsHelper.SKINALI_DELIVERY_PRICE)
															]
														}
													]
												}
								...
								},
								{
									...
									childSteps:[
										...
										printingTypeStep('step-91', _calculatorConstsHelper.DOORS_PHOTO_PRINTING_PRICE, _calculatorConstsHelper.DOORS_MONOCHROMATIC_PAINTING_PRICE),
										...
										delivetyStep('step-99-1', _calculatorConstsHelper.DOORS_DELIVERY_PRICE),
										installationStep('step-99-2', _calculatorConstsHelper.DOORS_INSTALATION_PRICE)
									]
								}
							]
						}]
