var orderStepsModule = (function(){
			...
			stepElements:[
				{
					...
					items: [{
						...
						},
						{
							id:`item-32-${stepId}`,
							title:'Осветленное',
							price: calculatorConstsHelper.SKINALI_CLARIFIED_GLASSTYPE_PRICE,
	...
	return {
		init: function(calculatorConstsHelperObj){
			calculatorConstsHelper = calculatorConstsHelperObj;
					...
					items:[
						{
							...
							childSteps:[
											...
											items: [
												{
													...
													title:'Название',
													childSteps:[
														printingTypeStep('step-17', calculatorConstsHelper.SHOWER_CABIN_PHOTO_PRINTING_PRICE, calculatorConstsHelper.SHOWER_CABIN_MONOCHROMATIC_PAINTING_PRICE),
								...
								delivetyStep('step-25-2', calculatorConstsHelper.SHOWER_CABIN_DELIVERY_PRICE),
								installationStep('step-25-3', calculatorConstsHelper.SHOWER_CABIN_INSTALATION_PRICE)
							]
						},
						{
							id:'item-29',
											...
											items:[
												{
													id:'item-62',
													title:'Надо',
													price:calculatorConstsHelper.SKINALI_METRING_PRICE,
													childSteps:[
														delivetyStep('step-59-2', calculatorConstsHelper.SKINALI_DELIVERY_PRICE),
														installationStep('step-59-3', calculatorConstsHelper.SKINALI_INSTALATION_PRICE)
													]
												},
												{
													id:'item-63',
													...
													isSelected:true,
													childSteps:[
														delivetyStep('step-59-4', calculatorConstsHelper.SKINALI_DELIVERY_PRICE)
													]
												}
											]
										}
						...
						},
						{
							...
							childSteps:[
								...
								printingTypeStep('step-91', calculatorConstsHelper.DOORS_PHOTO_PRINTING_PRICE, calculatorConstsHelper.DOORS_MONOCHROMATIC_PAINTING_PRICE),
								...
								delivetyStep('step-99-1', calculatorConstsHelper.DOORS_DELIVERY_PRICE),
								installationStep('step-99-2', calculatorConstsHelper.DOORS_INSTALATION_PRICE)
							]
						}
					]
				}]
